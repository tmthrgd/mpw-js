...
function updatePassword() {
  error.textContent = password.value = "";
  if (!mpw || !sitename.value || !sitename.validity.valid || !counter.validity.valid || !template.validity.valid || !type.validity.valid) {
    return;
  }
  var cid = ++id;
  if (type.value === "answer") {
    ...
    var value = mpw[$traceurRuntime.toProperty("generate" + Type)](sitename.value, counter.valueAsNumber, template.value);
  }
